...
const AdminOrdenes = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-gray-800 p-8 text-white">
      <h1 className="text-3xl font-bold mb-6 text-center">Panel de Órdenes (Administrador)</h1>
      ...
      {cargando ? (
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          {ordenes.map((orden) => (
            <div key={orden._id} className="bg-white/10 p-6 rounded-xl">
